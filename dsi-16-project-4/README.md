...
# Content
## Datasets
Datasets were obtained from Kaggle and consist of:
- **Train:** The training data consisting of sample data from 2007, 2009, 2011, and 2013.
- **Test data:**  The test data are samples from 2008, 2010, 2012, and 2014, for which we would need to predict the presence of the West Nile Virus.
- **Weather data:** Dataset from NOAA of the weather conditions of 2007 to 2014, during the months of the tests.
    - Supporting Document: Definitions and description for metrics in the weather dataset
- **Spray data:** Spray area and dates of insecticide spray efforts by the City of Chicago to kill mosquitos. Spray data is only available for year 2011 and 2013.
...
### (Supplementary) Notebook 3.5:
   - Additional Modelling Approach (Polynomial Features)
...
Our goal is to create a predictive model for us to identify the **presence of WNV** at different locations in Chicago, based on the time of year and other factors in Windy City.
...
# Executive Summary
The three main facets that best predicts the presence of West Nile Virus can be broken down into **Seasonality, Weather and Location**.
- **Seasonality:**
